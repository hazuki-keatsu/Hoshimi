...
pub struct CounterPage {
    ...
    /// Button pressed states: (decrement, reset, increment)
    btn_pressed: (bool, bool, bool),
...
impl CounterPage {
    ...
    fn make_shadow(pressed: bool) -> Option<BoxShadow> {
        if pressed {
...
impl Page for CounterPage {
    ...
    fn build(&self) -> Box<dyn Widget> {
        Box::new(Center::new(
            Column::new()
                .child(Text::new(&self.title).with_style(TextStyle {
                    font_size: 32.0,
                    color: Color::white(),
                    ..Default::default()
                }))
                ...
                .child(
                    Text::new(&format!("Count: {}", self.count)).with_style(TextStyle {
                        font_size: 48.0,
                    ...
                    Row::new()
                        .child(
                            GestureDetector::new(
                                Container::new()
                                    .child(
                                        Text::new("-").with_color(Color::white()).with_size(32.0),
                                    )
                                    .with_padding(EdgeInsets::all(10.0))
                                    .with_decoration(BoxDecoration {
                                        color: Some(Color::from_hex(0x1565C0)),
                                        border: Some(Border::new(Color::from_hex(0x00838F), 1.0)),
                                        border_radius: Some(BorderRadius::all(16.0)),
                                        box_shadow: Self::make_shadow(self.btn_pressed.0),
                                    })
                            ...
                            GestureDetector::new(
                                Container::new()
                                    ...
                                    .with_decoration(BoxDecoration {
                                        ...
                                        border: Some(Border::new(Color::from_hex(0x558B2F), 1.0)),
                                        border_radius: Some(BorderRadius::all(16.0)),
                                        box_shadow: Self::make_shadow(self.btn_pressed.1),
                                    })
                                    .with_alignment(Alignment::center())
                            ...
                            GestureDetector::new(
                                Container::new()
                                    ...
                                    .with_decoration(BoxDecoration {
                                        ...
                                        border: Some(Border::new(Color::from_hex(0xEF6C00), 1.0)),
                                        border_radius: Some(BorderRadius::all(16.0)),
                                        box_shadow: Self::make_shadow(self.btn_pressed.2),
                                    })
                                    .with_alignment(Alignment::center())
                                    .with_size(128.0, 128.0)
                            )
